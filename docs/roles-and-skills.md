...
- **Python** (scripting, automation, basic network libraries)
- **C++** (OOP concepts, pointers, memory management)
- **PowerShell** (basic system administration, task automation)
- **Git** (branching, merging, pull requests via GitHub)
- **SQLite** (basic SQL queries, CRUD operations)
- **Data Structures & Algorithms** (arrays, lists, trees, sorting, Big O analysis)
- **OS: MacOS, Windows** (advanced usage, terminal/CLI navigation)

### Skills I clearly lack

- **Computer Networking** (OSI Model, TCP/IP, DNS, HTTP/HTTPS, Subnetting)
- **Linux Administration** (Bash scripting, file permissions, system hardening)
- **Web Security** (OWASP Top 10, SQLi, XSS, Burp Suite basics)
- **Cloud Computing** (AWS/Azure basics, IAM, cloud security concepts)
...
- **Operating Systems Security** (Deep understanding of Windows & Linux internals)
- **Networking Protocols** (TCP/IP, OSI model, DNS, VPN principles)
- **Scripting & Automation** (Python, PowerShell, Bash for task automation)
- **SIEM/EDR experience** (Knowledge of monitoring and incident response tools)

### Skills specific to a single posting

- **Industrial Security (ICS/SCADA)** (Specific to the critical infrastructure role)
- **Russian Regulatory Compliance** (FSTEK, 187-FZ, CII protection)
